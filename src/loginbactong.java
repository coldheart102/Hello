 ...
 * @author Admin
 */
public class loginbactong extends javax.swing.JFrame {
java.sql.Connection conn = null;
ResultSet rs = null;
Statement st;
    /**
     * Creates new form loginbactong
     */
    public loginbactong() {
        initComponents();
...
//        scaleImage();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginbactong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginbactong().setVisible(true);
            }
        });
    }
