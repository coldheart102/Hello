    ...
    private void createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createActionPerformed
        ...
        if (user != null && pass.equals(repass)){
            try{
                ...
                st.executeUpdate("INSERT INTO BACTONG.DATAS"+user+" (CALENDAR, USERNAME, SWITCH, NUMBERUSED, TOTALHOURS, OPENHOURS) VALUES ('1000-03-09', '"+user+"',1,0,0,0)");
                st.executeUpdate("INSERT INTO BACTONG.DATAS"+user+" (CALENDAR, USERNAME, SWITCH, NUMBERUSED, TOTALHOURS, OPENHOURS) VALUES ('1001-04-10', '"+user+"',2,0,0,0)");
                st.executeUpdate("INSERT INTO BACTONG.DATAS"+user+" (CALENDAR, USERNAME, SWITCH, NUMBERUSED, TOTALHOURS, OPENHOURS) VALUES ('1002-05-11', '"+user+"',3,0,0,0)");
                st.executeUpdate("INSERT INTO BACTONG.DATAS"+user+" (CALENDAR, USERNAME, SWITCH, NUMBERUSED, TOTALHOURS, OPENHOURS) VALUES ('1002-06-12', '"+user+"',4,0,0,0)");
